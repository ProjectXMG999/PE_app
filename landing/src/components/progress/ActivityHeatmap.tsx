// Copied from src/components/progress/ActivityHeatmap.tsx (main app).
// Landing-only divergence: the legend row ("X z Y dni" + the mniej/więcej
// color scale) is removed — with synthetic mock data that stat reads as
// fake, unlike in the main app where it reflects a real user's activity.
  ...
  return (
    <div className="heatmap">
      ...
      <div
        ...
        role="img"
        aria-label={`Aktywność z ostatnich ${data.length} dni`}
      >
