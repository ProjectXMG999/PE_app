// Copied from src/components/progress/PaceSimulator.tsx (main app). Only
// edit: DAILY_GOAL_OPTIONS inlined locally instead of imported from
// store/useAppStore.ts (that module is a live Zustand store, not needed here
// — this standalone package never reads/writes app state).
