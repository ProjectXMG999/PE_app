// Copied from src/components/progress/ReadinessBreakdown.tsx (main app).
// Only edit: ReadinessResult now comes from a local, hand-declared type
// instead of the main app's hooks/useReadinessScore.ts (which also contains
// a live IndexedDB-touching hook at module scope — never imported here).
import { useState } from 'react'
import type { ReadinessResult } from '../../types/mockSnapshot'
