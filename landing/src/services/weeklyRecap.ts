// Copied from src/services/weeklyRecap.ts (main app). Only edits:
// ProgressSnapshot from the local mockSnapshot.ts type, studiedMinutes from
// the hand-extracted utils/studiedMinutes.ts.
