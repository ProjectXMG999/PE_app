// Copied from src/services/achievements.ts (main app). Only edit:
// ProgressSnapshot now comes from a local, hand-declared type instead of the
// main app's live-IndexedDB hook file. studiedMinutes comes from the
// hand-extracted utils/studiedMinutes.ts instead of hooks/useStats.ts.
import { ACHIEVEMENTS, Achievement, AchievementMetric } from '../data/achievements'
import type { ProgressSnapshot } from '../types/mockSnapshot'
import { DailyTime, Session } from '../types/progress'
import { PackMeta } from '../types/vocabulary'
import { studiedMinutes } from '../utils/studiedMinutes'
