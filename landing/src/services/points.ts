// Copied from src/services/points.ts (main app) — see landing/README or plan
// for drift-tracking notes. Only edit: ProgressSnapshot now comes from a
// local, hand-declared type instead of the main app's live-IndexedDB hook file.
