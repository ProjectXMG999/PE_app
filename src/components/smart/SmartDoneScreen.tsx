      ...
      <motion.div className="smartdone__content u-liquid" variants={staggerContainerWide} initial="hidden" animate="show">
        ...
        {moved && (
          <motion.p className="smartdone__comfort" variants={variants}>
            Poziom komfortu: {comfortBefore.toFixed(1)} → <strong><FlowNumber value={comfortAfter} delayMs={600} format={{ minimumFractionDigits: 1, maximumFractionDigits: 1 }} /></strong>
          </motion.p>
        )}
