...
const sentencesData = JSON.parse(fs.readFileSync(
  'C:\\Users\\MACIEJ~1\\AppData\\Local\\Temp\\claude\\c--Users-MaciejGrabarczyk-Desktop-an-PE-app\\f55d3ead-c000-4115-9ee5-7ab21bc41e05\\scratchpad\\sentences_batch2_correct.json',
  'utf-8'
));
...
console.log(`Loaded ${Object.keys(sentenceMap).length} sentences for batch 2`);
...
console.log('Done injecting sentences for batch 2');
