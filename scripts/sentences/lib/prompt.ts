...
- candidate1 = WSPÓŁCZESNOŚĆ / 2026 (obowiązkowe, nie "czasem"): zdanie osadzone we współczesnym, cyfrowym 2026 życiu — ale nazwa konkretnej marki jest RZADKOŚCIĄ, nie normą. Orientacyjnie: mniej więcej co 4. zdanie w tym gnieździe (w skali całej bazy, nie w jednej paczce) może nazwać realną markę/aplikację (Netflix, WhatsApp, TikTok, iPhone, Uber, Amazon, Google Maps, Spotify, Zoom, IKEA...) — pozostałe ~3 na 4 mają być równie współczesne, ale BEZ wymieniania konkretnej marki: zdalna praca, doomscrollowanie, wiadomość głosowa, powiadomienia, streaming, zakupy online, dostawa jedzenia, rolki/shorty, ekran telefonu, ładowanie baterii, spotkanie na czacie wideo. Przykłady BEZ marki (częstsze): "I ordered groceries online again.", "I've been doomscrolling all morning.", "My phone died before I could reply.", "I joined the call five minutes late.", "I've been binge-watching all week." Przykłady Z marką (rzadsze, ok. 1 na 4): "I left my MacBook at the office again.", "Send me the link on WhatsApp.", "I found this restaurant on TikTok.", "My iPhone is full again." Unikaj marek kontrowersyjnych, alkoholu, tytoniu, hazardu, broni, twierdzeń zdrowotnych — i nigdy nie wciskaj marki na siłę, jeśli słowo na to nie pozwala.
...
export function buildUserPrompt(batch: WordTask[], avoidWords: string[] = []): string {
  ...
  const parts = [
    ...
    `Wygeneruj 3 kandydatury zdań dla każdego z ${batch.length} poniższych słów tej samej paczki, według gniazd: candidate1 = współczesność/2026 (nazwa marki tylko okazjonalnie, ok. 1 na 4 zdania — resztę razy współczesny kontekst BEZ nazywania marki), candidate2 = mikroemocje/relacje/humor (zdanie do konkretnej osoby), candidate3 = ogólne, naturalne zdanie w rejestrze WhatsApp/Messenger.`,
